...
<head>
    ...
    @if(Session::get('locale') == 'ar')
        <link rel="stylesheet" href="{{ asset('assets/frontend/css/ar.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/frontend/css/style.css') }}">
    @endif
        ...
        <div class="header-top-bar">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="top-bar-info list-inline-item pl-0 mb-0 custRtl">
                    ...
                    <div class="col-lg-6">
                        <div class="text-lg-right top-right-bar mt-2 mt-lg-0 custRtl">
