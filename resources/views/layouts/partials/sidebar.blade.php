...
{{--        @can('dashboard')--}}
        <li class="{{ Request::is('admin/dashboard') ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('admin.dashboard.static') }}">
...
{{--            @can('plan.create')--}}
            <li><a class="nav-link {{ Request::is('admin/plans/create') ? 'active' : '' }}" href="{{ route('admin.plans.create') }}">{{ __('Create') }}</a></li>
{{--            @endcan--}}
{{--            @can('plan.list')--}}
            <li><a class="nav-link {{ Request::is('admin/plans') ? 'active' : '' }}" href="{{ route('admin.plans.index') }}">{{ __('All Plans') }}</a></li>
{{--            @endcan--}}
          </ul>
        </li>
{{--        @endif--}}
...
{{--        @can('customer.create','customer.list','customer.request','customer.list')--}}
        <li class="dropdown {{ Request::is('admin/customers*') ? 'active' : '' }}">
          ...
          <ul class="dropdown-menu">
{{--            @can('customer.create')--}}
            <li><a class="nav-link" href="{{ route('admin.customers.create') }}">{{ __('Create Customer') }}</a></li>
{{--            @endcan--}}
{{--            @can('customer.list')--}}
            <li><a class="nav-link" href="{{ route('admin.customers.index') }}">{{ __('All Customers') }}</a></li>
{{--            @endcan--}}
{{--            @can('customer.request')--}}
            <li><a class="nav-link" href="{{ route('admin.customers.index','type=3') }}">{{ __('Customer Request') }}</a></li>
{{--            @endcan--}}
{{--            @can('customer.list')--}}
            <li><a class="nav-link" href="{{ route('admin.customers.index','type=2') }}">{{ __('Suspended Customers') }}</a></li>
{{--            @endcan--}}
          </ul>
        </li>
{{--        @endcan--}}
...
{{--        @can('domain.create','domain.list')--}}
         <li class="dropdown {{ Request::is('admin/domains*') ? 'active' : '' }}">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="flaticon-www"></i> <span>{{ __('Domains') }}</span></a>
          <ul class="dropdown-menu">
{{--            @can('domain.create')--}}
            <li><a class="nav-link {{ Request::is('admin/domains/create') ? 'active' : '' }}" href="{{ route('admin.domains.create') }}">{{ __('Create Domain') }}</a></li>
{{--            @endcan--}}
{{--            @can('domain.list')--}}
            <li><a class="nav-link {{ Request::is('admin/domains') ? 'active' : '' }}" href="{{ route('admin.domains.index') }}">{{ __('All Domains') }}</a></li>


             <li><a class="nav-link {{ Request::is('admin/domains') ? 'active' : '' }}" href="{{ route('admin.customdomains.index') }}">{{ __('Custom Domains Requests') }}</a></li>
...
{{--        @can('page.create','page.list')--}}
        <li class="dropdown {{ Request::is('admin/pages*') ? 'active' : '' }}">
          ...
          <ul class="dropdown-menu">
{{--            @can('page.create')--}}
            <li><a class="nav-link" href="{{ route('admin.pages.create') }}">{{ __('Create Pages') }}</a></li>
{{--            @endcan--}}
{{--            @can('page.list')--}}
...
{{--        @can('language_edit')--}}
        <li class="dropdown {{ Request::is('admin/languages*') ? 'active' : '' }}">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="flaticon-translation"></i> <span>{{ __('Language') }}</span></a>
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="{{ route('admin.languages.create') }}">{{ __('Create language') }}</a></li>
            <li><a class="nav-link" href="{{ route('admin.languages.index') }}">{{ __('Manage language') }}</a></li>
          </ul>
        </li>
{{--        @endcan--}}
{{--       @can('site.settings')--}}
...
{{--            @endcan--}}
{{--            @can('admin.list')--}}
            <li><a class="nav-link" href="{{ route('admin.admins.index') }}">{{ __('Admins') }}</a></li>
{{--            @endcan--}}
          </ul>
        </li>
      </ul>
