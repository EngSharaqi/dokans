							...
							<table class="table table-hover table-nowrap card-table text-center">
								...
								<tbody class="list font-size-base rowlink" data-link="row">
									...
									<tr>
										...
										<td>{{ $key }}</td>
										<td>{{ $row }}</td>
										<td class="text-right"><a href="{{ route('admin.languages.show',$key) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
										<a href="{{ route('admin.languages.destroy',$key) }}" class="btn btn-danger btn-sm cancel"><i class="fa fa-trash"></i></a></td>
									</tr>
									@endforeach
								</tbody>
							</table>
