...
{{--                <form method="post" class="basicform_with_reload" action="{{ route('admin.admins.destroy') }}">--}}
{{--                    @csrf--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-lg-6">--}}
{{--                            <div class="d-flex">--}}
...
{{--                                <div class="single-filter">--}}
{{--                                    <button type="submit"--}}
{{--                                            class="btn btn-primary btn-lg ml-2 basicbtn">{{ __('Apply') }}</button>--}}
{{--                                </div>--}}
{{--                                --}}{{--                            @endcan--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                   class="btn btn-primary float-right">{{ __('Add New Admin') }}</a>--}}
{{--                            </div>--}}
{{--                            --}}{{--						@endcan--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                --}}{{--                                @can('admin.edit')--}}
{{--                                <div class="hover">--}}
{{--                                    <a href="{{ route('admin.admins.edit',$row->id) }}">{{ __('Edit') }}</a>--}}
...
{{--                                @endif</td>--}}
{{--                            <td>@foreach($row->roles as $r) <span--}}
{{--                                    class="badge badge-primary">{{ $r->name }}</span> @endforeach</td>--}}
...
{{--                            @can('admin.create')--}}
                                <div class="add-new-btn">
                                    <a href="{{ route('admin.admins.create') }}" class="btn btn-primary float-right">{{ __('Add New Admin') }}</a>
                                </div>
{{--                            @endcan--}}
                        </div>
                    </div>
