...
<div class="row">
  <div class="col-12 mt-2">
    <div class="card">
      <div class="card-body">
          <form method="post" action="{{ route('admin.plans.destroy') }}" class="basicform_with_reload">
            @csrf
            ...
            <table class="table table-striped table-hover text-center table-borderless">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td>
{{--                    @can('plan.edit')--}}
                    <a href="{{ route('admin.plans.edit',$row->id) }}" class="btn btn-primary btn-sm text-center"><i class="far fa-edit"></i></a>
{{--                    @endcan--}}
{{--                    @can('plan.show')--}}
                    <a href="{{ route('admin.plans.show',$row->id) }}" class="btn btn-success btn-sm text-center"><i class="far fa-eye"></i></a>
{{--                    @endcan--}}
                  </td>
                </tr>
                @endforeach
